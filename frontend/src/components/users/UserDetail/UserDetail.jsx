...
function UserDetail() {
  ...
  return (
    <div className={styles.container}>
      <img style={{ height: '120px', width: '120px', borderRadius: '50px 0 50px 0' }} src={profile_picture} alt={`Foto del usuario: ${fullname}`} />
      <h1 className={styles.nametext}>{user.fullname}</h1>
      <h4>{role === 'ADMIN' ? 'Administrador' : 'Event Creator'}</h4>
